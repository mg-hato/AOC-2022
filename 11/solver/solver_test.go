...
func TestD11_Solver(t *testing.T) {
	testers.DefaultSolverTesterForComparableTypeR(
		CalculateMonkeyBusiness(20, DivBy3),
		CalculateMonkeyBusiness(10_000, NoAdjustment),
		"CalculateMonkeyBusiness[20 rounds, DivideBy3Adjustment]",
		"CalculateMonkeyBusiness10KRounds[10K rounds, NoAdjustment]",
	).AddTest(m.CreateMonkeysEnvelopeWith([]m.Monkey{
		...
		101*96*20*20,
		101*96*10_000*10_000,
	).RunBothSolversTests(t)
}
